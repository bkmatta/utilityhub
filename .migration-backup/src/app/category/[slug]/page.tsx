...
// Generate meta tags for category routes
export async function generateMetadata({ params }: CategoryPageProps): Promise<Metadata> {
  ...
  return {
    title: `${info.title} - Free Online Utilities | UtilityHub`,
...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-3 pb-12 space-y-6">
      {/* Consolidated category page header */}
      ...
      {/* Grid listing of tools inside the category */}
